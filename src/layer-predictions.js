...
export class LayerPredictions {
    ...
    init() {
        ...
        console.log("Come on please", logitGroupComponent.height)
...
export class LogitBox {
    ...
    draw(selection) {
        ...
        selection.each(function (d, i) {
            ...
            const format_prob = (d.prob * 100).toFixed(2) + '%'
            pred_layer.append('text')
...
export class LogitGroup {
    constructor(_config = {}) {
        ...
        console.log("CONFIG", this.config, this._height, this.config.n_rows, this.logitComponent.height)
    }
    ...
    draw(selection){
        ...
        selection.each(function (d, i) {
            ...
            sel.append('text')
                ...
                .text((d,i)=>{
                    // console.log('here', typeof d['layer'] !== "undefined")
            ...
            sel
                ...
                .attr('transform', (d, i) => {
                        ...
                        // console.log('col rows', column, row, i, self)
